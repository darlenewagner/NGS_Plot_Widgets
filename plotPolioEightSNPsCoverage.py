...
for count in range(0, max(snpCoords11)):
        if(iter % 500 == 0):
...
iter = 0
for count in range(0, int(max(topCoverage)) + 10000):
        if(iter % 2000 == 0):
...
axes.set_title("SNPs of Raw MiSeq and iSeq Polio Samples", size=28)
axes.set_xlabel('Reference Genome, KM433732, Coordinates', size=15)
axes.set_ylabel('Coverage (X) at Position', size=15)
#axes.margins(0.2)

fig.savefig('/scicomp/home-pure/ydn3/test_Python3.9.1/test_Biopython/rawSNP_w' + '_' + shortTitle1t[0] + '_' + shortTitle2t[0] + '_' + shortTitle3t[0] + '_' + shortTitle4t[0] + '_' + shortTitle5t[0] + '_' + shortTitle6t[0] + '_' + shortTitle7t[0] + '_and_' + shortTitle8t[0] + '_to_KM433732.png')
