...
if(args.outputType == 'F'):
        fig.savefig('/scicomp/home-pure/ydn3/test_Python3.9.1/test_Biopython/QC_' + newTitle + '/fwd_and_revPHRED_allSevenHisto.png')

        totalPHRED = { "R1_Reads_Avg_PHRED" : lisFwdAvgPHRED, "R2_Reads_Avg_PHRED" : lisRevAvgPHRED }
        dfTotalPHRED = pd.DataFrame(totalPHRED)
        dfTotalPHRED.to_csv('/scicomp/home-pure/ydn3/test_Python3.9.1/test_Biopython/QC_' + newTitle + '/fwd_and_revPHRED_allSeven.csv')
