...
axes.set_title("SNPs of MiSeq and iSeq Polio Samples", size=28)
axes.set_xlabel('Reference Genome, Consensus 3015815424, Coordinates', size=15)
axes.set_ylabel('Coverage (X) at Position', size=15)
#axes.margins(0.2)

fig.savefig('/scicomp/home-pure/ydn3/test_Python3.9.1/test_Biopython/rawSNP_w' + '_' + shortTitle1t[0] + '_' + shortTitle2t[0] + '_' + shortTitle3t[0] + '_' + shortTitle4t[0] + '_and_' + shortTitle5t[0] + '_to_Consensus.png')
