...
if((rotavirus == 'Y') or (rotavirus == 'y')):
        axes.text(0.078, 0.96, 'Segment 1', transform=axes.transAxes)
        axes.text(0.22, 0.96, 'Segment 2', transform=axes.transAxes)
        axes.text(0.34, 0.96, 'Segment 3', transform=axes.transAxes)
        axes.text(0.46, 0.96, 'Segment 4', transform=axes.transAxes)
        axes.text(0.58, 0.96, 'Seg. 5', transform=axes.transAxes)
        axes.text(0.65, 0.96, 'Seg. 6', transform=axes.transAxes)
        axes.text(0.72, 0.96, 'Seg. 7', transform=axes.transAxes)
        axes.text(0.775, 0.91, 'Seg. 8', transform=axes.transAxes)
        axes.text(0.825, 0.86, 'Seg. 9', transform=axes.transAxes)
        axes.text(0.875, 0.81, 'Seg. 10', transform=axes.transAxes)
        axes.text(0.915, 0.76, 'Seg. 11', transform=axes.transAxes)
